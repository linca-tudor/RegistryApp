...
#import <react-native-lottie-splash-screen/RNSplashScreen.h>
#import "registryapp-Swift.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  UIView *rootView = RCTAppSetupDefaultRootView(bridge, @"registryapp", initProps);
